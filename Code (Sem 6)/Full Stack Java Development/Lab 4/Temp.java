...
public class Temp {
    public static void main(String[] args) {
        try{
            ...
            Connection con=DriverManager.getConnection("jdbc:mysql://localhost:3306/6chd1", "root", "xohylys93");
            Statement stmt=con.createStatement();
            int ans=1;
            do{
                System.out.println("1.Insert a record");
                System.out.println("2.Delete a record");
                System.out.println("3.Modify existing entries");
                ...
                switch (ch) {
                    ...
                    case 2:
                        ...
                        stmt.executeUpdate(query);
                        System.out.println("Record is deleted from table succesfully");
                        break;
                    case 3:
